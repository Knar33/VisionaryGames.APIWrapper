...
{
    class GetWorldRequest
    {
        public GetWorldRequest(AuthenticationStore auth, APIConnection connection)
        {
            Auth = auth;
        ...
        public GetWorldResponse Send()
        {
            ...
            var res = client.Execute<GetWorldResponse>(request);

            return new GetWorldResponse(res);
        }
    }
}
