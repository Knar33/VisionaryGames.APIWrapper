...
{
    class GetTowerRequest
    {
        public GetTowerRequest(AuthenticationStore auth, APIConnection connection)
        {
            Auth = auth;
        ...
        public GetTowerResponse Send()
        {
            ...
            var res = client.Execute<GetTowerResponse>(request);

            return new GetTowerResponse(res);
        }
    }
}
